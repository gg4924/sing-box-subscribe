...
def config(url):
    if any(substring in url for substring in ['gitlab.com', 'sing-box-subscribe.vercel.app', 'sub/merged_proxies.yaml', 'https:/https:/', 'xxxx', 'URL_LINK', 'URLLINK', '机场', '订阅', '你的', 'SUB', '链接']):
        return None
